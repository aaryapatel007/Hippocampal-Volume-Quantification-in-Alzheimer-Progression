...
from loss_function.dice_loss import SoftDiceLoss
...
class UNetExperiment:
    ...
    def __init__(self, config, split, dataset):
        ...
        self.dice_loss = SoftDiceLoss(batch_dice = True)
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: We get the probability for each class of each pixel.
    ...
    def save_model_parameters(self):
        ...
        """
        path = os.path.join(self.out_dir, "unet_model_with_CE_loss_10_epochs.pth")
    ...
    def load_model_parameters(self, path=''):
        ...
        """
        if not path:
            model_path = os.path.join(self.out_dir, "unet_model_with_CE_loss_10_epochs.pth")
        else:
            model_path = path
